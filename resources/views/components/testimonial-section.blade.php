    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex flex-col items-center">
            <div class="text-center">
                ...
                <h2 class="mt-4 text-3xl font-bold text-gray-900 underline sm:text-4xl xl:text-5xl font-Playfair decoration-pink-500">Our happy clients say about us</h2>
            </div>
            ...
            <div class="relative mt-10 md:mt-24 md:order-2">
                <div class="absolute -inset-x-1 inset-y-16 md:-inset-x-2 md:-inset-y-6">
                    <div class="w-full h-full max-w-5xl mx-auto rounded-3xl opacity-30 blur-lg filter bg-gradient-to-r from-pink-400 to-pink-400 via-pink-300"></div>
                </div>
